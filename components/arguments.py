...
def policy_function(args):
    ...
    args.n_policy_update_iters = 3      # training times for each agent updating
...
def value_function(args):
    ...
    args.value_lr = 1e-4
    args.value_loss = 'huber'  # 'huber' or 'mse'
    return args
...
def dynamics_model(args):
    ...
    args.model_n_layers = 3                              # number of hidden layers in the model (at least 2)
    args.model_sampling_type = "random"                  # ['random', 'ensemble']
